...
export function Sidebar({ }): React.JSX.Element {
    return (
        <div className={cn("sticky top-0 left-0 h-full w-full md:max-w-sidebar-width bg-greyspace z-50",
            open_sans.className
        )}>
            <div className="h-logo-container-height md:h-logo-container-height-md w-full text-white flex">
                <div className="relative w-full flex justify-center items-center bg-amber-200">
                    <Image
                        src="/bg-blue.png"
                        alt="Background Blue"
            ...
            <div className="overflow-y-auto h-0 md:h-[calc(100vh-(var(--spacing-logo-container-height-md))-(var(--spacing-radioplayer-height-md)))]"> {/* Adjust height to account for header and radio player */}
                ...
                <div className="my-5 px-10">
                    <h2 className="mt-10 mb-3 font-bold uppercase">Connect With Us</h2>
                    {/* TODOS: change to icon library */}
