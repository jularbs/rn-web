...
export function StationDetailsComponent(): React.ReactNode | null {
    ...
    if(!selectedStation || selectedStation.default) return null;
    return (
        <>
            <div className="grid gap-3">
                <div>
                    <p className="text-2xl font-extrabold uppercase text-center text-radyonatin-blue">{selectedStation.name}</p>
                </div>
